...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `data` property of this instance returns the response data which is of type [`Database`](../../doc/models/database.md).
...
|  --- | --- | --- | --- |
| `notion_version` | `String` | Header, Required | The version of the Notion API to use. The current version is 2022-06-28. This header is required for all API requests. |
| `database_id` | `UUID \| String` | Template, Required | The ID of the database to retrieve. |
...
|  --- | --- | --- | --- |
| `notion_version` | `String` | Header, Required | The version of the Notion API to use. The current version is 2022-06-28. This header is required for all API requests. |
| `database_id` | `UUID \| String` | Template, Required | The ID of the database to update. |
...
|  --- | --- | --- | --- |
| `notion_version` | `String` | Header, Required | The version of the Notion API to use. The current version is 2022-06-28. This header is required for all API requests. |
| `database_id` | `UUID \| String` | Template, Required | The ID of the database to query. |
| `filter_properties` | `Array[String]` | Query, Optional | A list of property IDs to include in the response. Only the specified properties will be returned for each page. |
...
body = DatabasesQueryRequest.new(
  page_size: 100
)
