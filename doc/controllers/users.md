...
| `page_size` | `Integer` | Query, Optional | Maximum number of users to return (max 100).<br><br>**Constraints**: `<= 100` |
...
|  --- | --- | --- | --- |
| `notion_version` | `String` | Header, Required | The version of the Notion API to use. The current version is 2022-06-28. This header is required for all API requests. |
| `user_id` | `UUID \| String` | Template, Required | The ID of the user to retrieve. |
